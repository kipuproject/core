...
class Configurador{
	...
	private function rescatarVariablesDB(){
		...
		if ($this->conexionDB->getEnlace()) {
			...
			$cadena_sql.=" valor  ";
			$cadena_sql.="FROM ";
			$cadena_sql.=$this->configuracion["dbprefijo"] . "settings ";
	...
	/**
	 * Método. Utiliza un objeto de la clase funcionGeneral para obtener los valores
	 * correspondientes a la sesión actual.
	 */
