...
if(class_exists('BloqueinternalBooking') === false){
	class BloqueinternalBooking implements Bloque
	{
		...
		public function __construct($esteBloque,$lenguaje="es_es")
		{
...
$unBloque["nombre"]="internalBooking";
$unBloque["grupo"]="host/back";
